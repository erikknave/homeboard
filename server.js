...
var parseStationData = function (device) {
  ...
  if (
    ...
    // Return the parsed station data as JSON. If data is invalid, log the device information for debugging.
var parseStationData = function (device) {
    return json_data;
  } else {
...
gpio.on("change", function (channel, value) {
  // GPIO event handler to detect changes and potentially disable the screensaver by simulating mouse movement.
gpio.on('change', function (channel, value) {
  // export DISPLAY=:0
  // xset s 2
